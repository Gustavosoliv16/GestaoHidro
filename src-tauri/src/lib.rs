...
#[tauri::command]
fn restaurar_backup(caminho_backup: String, app: tauri::AppHandle) -> Result<String, String> {
    if !std::path::Path::new(&caminho_backup).exists() {
    ...
    fs::copy(&caminho_backup, &db_path)
